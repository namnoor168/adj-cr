...
if( !class_exists('Ftc_Products_Widget') ){
	class Ftc_Products_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-items-widget', 'description' => esc_html__('Display your products on site','ftc-element'));
			parent::__construct('ftc_products', esc_html__('FTC - Products','ftc-element'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			function form( $instance ) {
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('product_type')); ?>"><?php esc_html_e('Product type', 'ftc-element'); ?> </label>
					<select class="widefat" id="<?php echo esc_attr($this->get_field_id('product_type')); ?>" name="<?php echo esc_attr($this->get_field_name('product_type')); ?>">
						<option value="recent" <?php selected($instance['product_type'], 'recent'); ?>><?php esc_html_e('Recent', 'ftc-element'); ?></option>
						<option value="sale" <?php selected($instance['product_type'], 'sale'); ?>><?php esc_html_e('Sale', 'ftc-element'); ?></option>
						<option value="featured" <?php selected($instance['product_type'], 'featured'); ?>><?php esc_html_e('Featured', 'ftc-element'); ?></option>
						<option value="best_selling" <?php selected($instance['product_type'], 'best_selling'); ?>><?php esc_html_e('Best selling', 'ftc-element'); ?></option>
						<option value="top_rated" <?php selected($instance['product_type'], 'top_rated'); ?>><?php esc_html_e('Top rated', 'ftc-element'); ?></option>
						<option value="mixed_order" <?php selected($instance['product_type'], 'mixed_order'); ?>><?php esc_html_e('Mixed order', 'ftc-element'); ?></option>
					</select>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_thumbnail')); ?>"><?php esc_html_e('Show thumbnail', 'ftc-element'); ?></label>
				</p>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('thumbnail_size')); ?>"><?php esc_html_e('Thumbnail size', 'ftc-element'); ?> </label>
					<select class="widefat" id="<?php echo esc_attr($this->get_field_id('thumbnail_size')); ?>" name="<?php echo esc_attr($this->get_field_name('thumbnail_size')); ?>">
						<option value="shop_thumbnail" <?php selected($instance['thumbnail_size'], 'shop_thumbnail'); ?>><?php esc_html_e('Product Thumbnails', 'ftc-element'); ?></option>
						<option value="shop_catalog" <?php selected($instance['thumbnail_size'], 'shop_catalog'); ?>><?php esc_html_e('Catalog Images', 'ftc-element'); ?></option>
						<option value="shop_single" <?php selected($instance['thumbnail_size'], 'shop_single'); ?>><?php esc_html_e('Single Product Image', 'ftc-element'); ?></option>
					</select>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_categories')); ?>"><?php esc_html_e('Show categories', 'ftc-element'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_product_title')); ?>"><?php esc_html_e('Show product title', 'ftc-element'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_price')); ?>"><?php esc_html_e('Show price', 'ftc-element'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_rating')); ?>"><?php esc_html_e('Show rating', 'ftc-element'); ?></label>
				</p>
