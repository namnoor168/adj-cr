...
<div class="container">
	<div id="primary" class="content-area">
		...
		<main id="main" class="site-main <?php if( ($page_column_class['left_sidebar'] && $post->post_type != 'ftc_footer') || ($page_column_class['right_sidebar']) &&  $post->post_type != 'ftc_footer') { ?> col-sm-9 <?php } ?>" >
