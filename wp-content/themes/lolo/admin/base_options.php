...
class FTC_Basic_Options {
	...
	function _load_base_options() {
		...
		$smof_data = array(
			...
			'ftc_text_logo' => 'Lolo Store',
			'ftc_header_layout' => 'layout3',
