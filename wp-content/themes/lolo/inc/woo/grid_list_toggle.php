...
if( !class_exists('Ftc_Grid_List') && ftc_has_woocommerce() ){
	class Ftc_Grid_List{
		function __construct(){
			...
			$this->settings = array(
				array(
					'name' => esc_html__( 'Default catalog view', 'lolo' ),
					'type' => 'title',
					'id' => 'ftc_glt_options'
				),
				array(
					'name' 		=> esc_html__( 'Catalog view', 'lolo' ),
					'desc_tip' 	=> '',
					'id' 		=> 'ftc_enable_glt',
					'type' 		=> 'checkbox',
					'desc' 		=> esc_html__('Display option to show product in grid or list view', 'lolo'),
					'default' 	=> 'yes'
				),
				array(
					'name' 		=> esc_html__( 'Default catalog view', 'lolo' ),
					'desc_tip' 	=> esc_html__( 'Display products in grid or list view by default', 'lolo' ),
					'id' 		=> 'ftc_glt_default',
					'type' 		=> 'select',
					'options' 	=> array(
						'grid'  => esc_html__('Grid', 'lolo'),
						'list' 	=> esc_html__('List', 'lolo')
					)
				),
		...
		function gridlist_toggle_button() {
			...
			<nav class="grid_list_nav">
				<a href="#" id="grid" title="<?php echo esc_attr('Grid view', 'lolo'); ?>">&#8862; <span><?php echo esc_html__('Grid view', 'lolo'); ?></span>
					<svg version="1.1" id="Layer_1" class="svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="19px" height="19px" viewBox="0 0 19 19" enable-background="new 0 0 19 19" xml:space="preserve"> <rect width="5" height="5"></rect> <rect x="7" width="5" height="5"></rect> <rect x="14" width="5" height="5"></rect> <rect y="7" width="5" height="5"></rect> <rect x="7" y="7" width="5" height="5"></rect> <rect x="14" y="7" width="5" height="5"></rect> <rect y="14" width="5" height="5"></rect> <rect x="7" y="14" width="5" height="5"></rect> <rect x="14" y="14" width="5" height="5"></rect> </svg>
				</a>
				
				<a href="#" id="columns4" title="<?php echo esc_attr('Grid-4-columns', 'lolo'); ?>">&#8863; <span><?php echo esc_html__('Grid 4 Columns', 'lolo'); ?></span>
				...
				<a href="#" id="list" title="<?php echo esc_attr('List view', 'lolo'); ?>">&#8863; <span><?php echo esc_html__('List view', 'lolo'); ?></span>
